...
export default function SpeedPanel({ car, level, isMobile }) {
  ...
  return (
    <div style={{
      ...
      minWidth: isMobile ? 180 : 190,
      transform: isMobile ? 'scale(0.9)' : 'none',
      transformOrigin: 'bottom left',
    }}>
      {/* Speed + limit roundel */}
      <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between', gap: isMobile ? 8 : 14 }}>
        <div>
          <div style={{
            fontSize: isMobile ? 8 : 10, letterSpacing: 2.5, fontWeight: 800, marginBottom: 4,
          ...
          <div style={{ display: 'flex', alignItems: 'baseline', gap: 6 }}>
            <span style={{
              fontSize: isMobile ? 42 : 58, fontWeight: 900, lineHeight: 1, letterSpacing: -3,
            ...
            <span style={{ fontSize: isMobile ? 12 : 15, fontWeight: 600, color: 'rgba(255,255,255,0.55)', marginBottom: isMobile ? 4 : 6 }}>
              km/h
            </span>
          </div>
        </div>
        ...
        <div style={{ textAlign: 'center', paddingBottom: 2 }}>
          <div style={{
            fontSize: isMobile ? 8 : 10, letterSpacing: 2, fontWeight: 700, marginBottom: 6,
            color: 'rgba(255,255,255,0.45)',
          }}>
            LIMIT
          </div>
          <div style={{
            width: isMobile ? 44 : 58, height: isMobile ? 44 : 58, borderRadius: isMobile ? 22 : 29,
            background: '#fff',
            border: `5px solid ${over ? '#ff5533' : '#c0282a'}`,
            display: 'flex', alignItems: 'center', justifyContent: 'center',
            fontWeight: 900, fontSize: isMobile ? 18 : 22, color: '#1a1a1a',
      ...
      <div style={{ position: 'relative', height: isMobile ? 4 : 6, background: 'rgba(255,255,255,0.1)', borderRadius: 3 }}>
        <div style={{
        ...
        <div style={{
          position: 'absolute',
          left: `${limitPct}%`,
          top: isMobile ? -2 : -3, width: 2, height: isMobile ? 8 : 12, borderRadius: 1,
